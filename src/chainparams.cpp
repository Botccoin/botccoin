...
public:
    CMainParams() {
        ...
        // BIP34 is never enforced in Botccoin v2 blocks, so we enforce from v3
        ...
        // XXX: BIP heights and hashes all need to be updated to Botccoin values
        ...
        vSeeds.push_back(CDNSSeedData("multiBotc.org", "seed.multiBotc.org", true));
        vSeeds.push_back(CDNSSeedData("multiBotc.org", "seed2.multiBotc.org"));

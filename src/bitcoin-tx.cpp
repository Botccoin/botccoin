...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || IsArgSet("-?") || IsArgSet("-h") || IsArgSet("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s Botccoin-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  Botccoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded Botccoin transaction") + "\n" +
              "  Botccoin-tx [options] -create [commands]   " + _("Create hex-encoded Botccoin transaction") + "\n" +
              "\n";

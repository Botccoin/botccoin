...
// Botccoin: Normally minimum difficulty blocks can only occur in between
...
unsigned int CalculateBotccoinNextWorkRequired(const CBlockIndex* pindexLast, int64_t nFirstBlockTime, const Consensus::Params& params)
{
...
CAmount GetBotccoinBlockSubsidy(int nHeight, const Consensus::Params& consensusParams, uint256 prevHash)
{

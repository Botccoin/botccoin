...
/** Recommended transaction fee by Botccoin Core developers
  *
 ...
 *
 *  Botccoin:    Increment mempool limits and accept RBF in steps of 0.0001 Botc
...
/**
 * Botccoin: Default dust limit that is evaluated when considering whether a
...
/**
 * Botccoin: Default hard dust limit that is evaluated when considering whether

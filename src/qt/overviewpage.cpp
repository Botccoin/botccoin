...
void OverviewPage::UpdateTip()
{
    QStringList tips = {
        ...
        tr("To see ongoing development and contribute, checkout Botccoin repository on GitHub!"),
        tr("Services that claim to double your Botccoins are always ponzi schemes")
    };

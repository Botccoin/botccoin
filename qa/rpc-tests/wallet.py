...
class WalletTest (BitcoinTestFramework):
    ...
    def run_test (self):
        ...
        # Send 210.000 Botc from 0 to 2 using sendtoaddress call.
        ...
        # node0 should end up with 1.000.000 Botc in block rewards plus fees, but
        ...
        # Send 100000 Botc with subtract fee from amount

...
class P2PPolicyTests(BitcoinTestFramework):
    ...
    def setup_network(self):
        ...
        # a Botccoin Core node that behaves similar to mainnet policies
    ...
    def run_test(self):
        ...
        ### test constants ###
        koinu = Decimal("0.00000001")          # 1 Koinu expressed in Botc
        ten = Decimal("10.0")                  # uniform 10 Botc seed moneys
        ...
        # create a bunch of UTXO with seed money from the Botccoin Core wallet
        for i in range(10):
        ...
        # test legacy output of 1 Botc output and 1 Botc fee
    ...
    # spend seed money with a key not in the Botccoin Core wallet.
    def spend_utxo(self, output):
        # construct the transaction using Botccoin Core raw tx APIs
        ...
        # and send the tx from there rather than from Botccoin Core, to test
